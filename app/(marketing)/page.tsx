  ...
  return (
    <>
      <section className="pt-6 md:pt-10 lg:py-32 pb-8 md:pb-12">
        <div className="container text-center flex flex-col gap-4 items-center max-w-[64rem]">
          <Link
          ...
          <p className="text-muted-foreground sm:text-xl leading-normal max-w-[42rem]">
            このアプリケーションはNext.js App RouterとTailwind
            CSSを使用して作成されています。
          </p>
        ...
        <div className="mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-[64rem]">
          ...
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 h-[180px]">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Planet Scale</h3>
                <p className="text-sm text-muted-foreground">
                  AppRouter/Layouts/APIRoutesの技術を使用。
                </p>
              </div>
      ...
      <section id="contact" className="container py-8 md:py-12 lg:py-24">
        <div className="max-w-[58rem] mx-auto text-center flex flex-col gap-4">
          ...
          <p className="text-muted-foreground sm:text-lg sm:leading-7">
            もしもWebサービスが気になった場合は、下記からDMでご連絡ください。
            <br />
            ご連絡お待ちしております。
          </p>
          <Link
